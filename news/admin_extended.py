...
class HeadlineScoreAdmin(admin.ModelAdmin):
    list_display = ("headline_preview", "overall_score_badge", "rss_source", "is_processed", "created_at")
    list_filter = (
        "is_processed",
        "rss_source",
        "created_at",
    ...
    fieldsets = (
        ("Başlık Bilgileri", {"fields": ("original_headline", "rss_source", "word_count", "character_count")}),
        (
        ...
        ("Durum", {"fields": ("is_processed", "article")}),
...
class ContentQualityMetricsAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Genel Kalite", {"fields": ("overall_quality_score",)}),
        ("Tarihler", {"fields": ("created_at", "updated_at"), "classes": ("collapse",)}),
    )
