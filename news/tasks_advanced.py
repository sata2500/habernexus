...
def check_duplicate_task(self, article_data: dict) -> dict:
    ...
    try:
        ...
        # Duplicate kontrol
        is_dup, similar_article = DuplicateDetector().find_similar_articles(
            title, category, days=7
        )
...
def select_author_style_task(self, article_data: dict) -> dict:
    ...
    try:
        ...
        # Yazar ve stil seç
        author, style = AuthorStyleSelector.select_author_and_style(
