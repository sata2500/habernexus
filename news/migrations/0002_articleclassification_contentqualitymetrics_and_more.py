    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(blank=True, help_text="İkincil kategoriler (virgülle ayrılmış)", max_length=500),
                ),
                (
                    "research_depth",
                    models.IntegerField(
                ...
                (
                    ...
                    models.CharField(default="gemini-2.5-flash", help_text="Önerilen AI modeli", max_length=50),
                ),
                (
                    "requires_fact_checking",
                    models.BooleanField(default=True, help_text="Gerçeklik kontrolü gerekli mi?"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(default=0, help_text="Birincil anahtar kelime kullanım sayısı"),
                ),
                (
                    "secondary_keyword_count",
                    models.IntegerField(default=0, help_text="İkincil anahtar kelime kullanım sayısı"),
                ),
                (
                    "keyword_density",
                    models.FloatField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "used_for",
                    models.CharField(blank=True, help_text="Kaynağın hangi amaç için kullanıldığı", max_length=255),
                ),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ["-created_at"],
                "indexes": [
                    models.Index(fields=["article", "stage"], name="news_conten_article_801c04_idx"),
                    models.Index(fields=["status"], name="news_conten_status_a90ffb_idx"),
                    models.Index(fields=["-created_at"], name="news_conten_created_d75e3b_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["-overall_score"], name="news_headli_overall_ac6438_idx"),
                    models.Index(fields=["is_processed"], name="news_headli_is_proc_2328fc_idx"),
                    models.Index(fields=["rss_source", "-overall_score"], name="news_headli_rss_sou_e887b5_idx"),
                ],
            },
        ),
    ]
