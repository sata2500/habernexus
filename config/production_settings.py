# Production ortamı için Django ayarları
# Bu dosya habernexus_config/settings.py tarafından import edilir
...
# Güvenlik ayarları
DEBUG = False
ALLOWED_HOSTS = os.getenv("ALLOWED_HOSTS", "habernexus.com,www.habernexus.com").split(",")
...
LOGGING = {
    ...
    "handlers": {
        ...
        "file": {
            ...
            "filename": "/var/log/habernexus/django.log",
        ...
        "celery_file": {
            "level": "INFO",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": "/var/log/habernexus/celery.log",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
            "formatter": "verbose",
        },
...
DATABASES = {
    "default": {
        ...
        "USER": os.getenv("DB_USER", "habernexus"),
