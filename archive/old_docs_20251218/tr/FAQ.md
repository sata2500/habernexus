...
**C:** Evet, manuel kurulum da mümkündür. Ancak, tüm bağımlılıkları (Python, PostgreSQL, Redis) kendiniz kurmanız ve yapılandırmanız gerekir. Detaylı adımlar için **[Kurulum Rehberi](INSTALLATION.md)**\'nin "Yerel Geliştirme Ortamı Kurulumu" bölümünü inceleyebilirsiniz.
